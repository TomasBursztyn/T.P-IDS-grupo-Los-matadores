...
#aca agrego un if la cual funciona si la peticion es del tipo post guarda en tres variables la informacion respectiva para luego imprimirlas y si la peticion es del tipo get te envia a la ruta de contact
